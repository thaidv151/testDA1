...
if (isset($_SESSION['username'])) {
    ...
    match ($act) {
        // Trang Login
            ...
            'thong-tin-ca-nhan' => (new clientController())->thongTinCaNhan(),

          
            'post-sua-thong-tin-ca-nhan' => (new clientController())->postEditCaNhanQuanTri(),

            'post-sua-mat-khau-ca-nhan' => (new clientController())->postEditmatKhauCaNhan(),
