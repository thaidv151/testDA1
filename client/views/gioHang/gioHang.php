            ...
            <div style="margin-top: 20px; width: 90%; margin-bottom:20px" class="product-item card">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        <a href="<?= BASE_URL_CLIENT . '?act=chi-tiet-san-pham&id=' . $sanPham['id_san_pham'] ?>" style="text-align: center;">
                            <div style="width: 300px; height:300px; background-image:url('<?= '.' . $sanPham['hinh_anh'] ?>'); background-repeat: no-repeat;  background-position: center; marign:auto 0px; background-size:contain;"></div>
                        </a>
                    </div>
                    <div class="form-group col-md-6">
                        <ul>
                            <li class="title"><a href="<?= BASE_URL_CLIENT . '?act=chi-tiet-san-pham&id=' . $sanPham['id_san_pham'] ?>"><?= $sanPham['ten_san_pham']  ?></a></li>
                            ...
                            <div class="form-group col-md-12 row text-right">
                                ...
                                <div class="form-group col-md-2">
                                    <a title="Xóa sản phẩm" href="<?= BASE_URL_CLIENT . '?act=delete-gio-hang&id=' . $sanPham['id'] ?>"><button onclick="confirm('Bạn có xác nhận xóa ?')" class="btn btn-warning"><i class="bi bi-trash3-fill"></i></button></a>
                                </div>

                             
                                <form action="<?= BASE_URL_CLIENT . '?act=dat-hang&san_pham_id=' . $sanPham['id_san_pham'] ?>" method="POST">
                                    <input type="number" name="so_luong" value="<?= $sanPham['so_luong'] ?>" hidden> 
                                <button type="submit" class="btn btn-danger">Mua ngay ></i></button>
                                </form>
                            </div>
