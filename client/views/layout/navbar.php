<div class="navbar card">
            <div class="form-row col-md-12">
                <div class="form-group col-md-2">
                    <img src="./assets/images/petshop.jpg" alt="ảnh">
                </div>
                ...
                <div class="form-group col-md-1">
                        ...
                        <a  href="<?= BASE_URL_CLIENT . '?act=thong-tin-ca-nhan' ?>"><img style="width: 30px; height :30px; border-radius:50%;" title="Thông tin cá nhân" src="<?= '.' . $user['hinh_anh']; ?>" alt="" onerror="this.onerror=null; this.src= '../uploads/th.jpg'"></a>
